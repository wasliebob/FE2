...
public class Bees {
	...
	public static void initSpecies()
	{
		...
		if(OreDictionary.getOres("ingotConductiveIron").size() > 0){
			...
			conductiveBee.addProduct(new ItemStack(Bees.comb, 1, 6), 25)	
		...
		if(OreDictionary.getOres("ingotElectricalSteel").size() > 0){
			...
			electricalBee.addProduct(new ItemStack(Bees.comb, 1, 7), 25)	
		...
		if(OreDictionary.getOres("ingotEnergeticAlloy").size() > 0){
			...
			energeticBee.addProduct(new ItemStack(Bees.comb, 1, 8), 25)	
		...
		if(OreDictionary.getOres("ingotVibrantAlloy").size() > 0){
			...
			vibrantBee.addProduct(new ItemStack(Bees.comb, 1, 9), 25)	
		...
		if(OreDictionary.getOres("ingotPulsatingIron").size() > 0){
			...
			pulsatingBee.addProduct(new ItemStack(Bees.comb, 1, 10), 25)	
		...
		if(Loader.isModLoaded("Botania")){
			...
			botanistBee.addProduct(new ItemStack(Bees.comb, 1, 11), 50)	
	...
	{
		new BeeMutation(Allele.getBaseSpecies("Industrious"), Allele.getBaseSpecies("Noble"), GenomeManager.getReinforcedTemplate(), 5, false, Bees.reinforcedBee, "FE2");
		new BeeMutation(Allele.getBaseSpecies("Industrious"), Bees.reinforcedBee, GenomeManager.getDraconicTemplate(), 5, false, Bees.draconicBee, "FE2");
		
		if(Loader.isModLoaded("Thaumcraft") && OreDictionary.getOres("ingotThaumium").size() > 0){
			new BeeMutation(Bees.silverwoodBee, Bees.greatwoodBee, GenomeManager.getThaumiumTemplate(), 5, false, Bees.thaumiumBee, "TC4");}
		
		if(Loader.isModLoaded("ThaumcraftExtras") && OreDictionary.getOres("ingotDarkThaumium").size() > 0){
			new BeeMutation(Bees.thaumiumBee, Allele.getBaseSpecies("Edenic"), GenomeManager.getDarkThaumiumTemplate(), 5, false, darkThaumiumBee, "TCE");}
	
		if(Loader.isModLoaded("ExtraTiC") && OreDictionary.getOres("ingotPokefennium").size() > 0){
			new BeeMutation(Bees.reinforcedBee, Allele.getBaseSpecies("Edenic"), GenomeManager.getPokefenniumTemplate(), 5, false, Bees.pokefenniumBee, "ExtraTiC");}
		
		if(Loader.isModLoaded("ExtraTiC") && OreDictionary.getOres("ingotFairy").size() > 0){
			new BeeMutation(Bees.reinforcedBee, Allele.getBaseSpecies("Heroic"), GenomeManager.getFairyTemplate(), 5, false, Bees.fairyBee, "ExtraTiC");}
		
		if(OreDictionary.getOres("woodGreatwood").size() > 0){
			new BeeMutation(Allele.getBaseSpecies("Industrious"), Allele.getBaseSpecies("Edenic"), GenomeManager.getGreatwoodTemplate(), 5, false, Bees.greatwoodBee, "TC4");}

		if(OreDictionary.getOres("woodSilverwood").size() > 0){
			new BeeMutation(Bees.greatwoodBee, Allele.getBaseSpecies("Edenic"), GenomeManager.getSilverwoodTemplate(), 5, false, Bees.silverwoodBee, "TC4");}

		if(OreDictionary.getOres("ingotConductiveIron").size() > 0){
			new BeeMutation(Bees.reinforcedBee, Allele.getBaseSpecies("Unweary"), GenomeManager.getConductiveTemplate(), 5, false, Bees.conductiveBee, "EIO");}

		if(OreDictionary.getOres("ingotElectricalSteel").size() > 0){
			new BeeMutation(Bees.reinforcedBee, Allele.getBaseSpecies("Diligent"), GenomeManager.getElectricalTemplate(), 5, false, Bees.electricalBee, "EIO");}

		if(OreDictionary.getOres("ingotEnergeticAlloy").size() > 0){
			new BeeMutation(Bees.reinforcedBee, Allele.getBaseSpecies("Heroic"), GenomeManager.getEnergeticTemplate(), 5, false, Bees.energeticBee, "EIO");}

		if(OreDictionary.getOres("ingotVibrantAlloy").size() > 0){
			new BeeMutation(Bees.draconicBee, Allele.getBaseSpecies("Heroic"), GenomeManager.getVibrantTemplate(), 5, false, Bees.vibrantBee, "EIO");}

		if(OreDictionary.getOres("ingotPulsatingIron").size() > 0){
			new BeeMutation(Bees.draconicBee, Bees.energeticBee, GenomeManager.getPulsatingTemplate(), 5, false, Bees.pulsatingBee, "TC4");}
	...
	public static void initCombs()
	{
		...
		products = new ItemStack[]{new ItemStack(Items.nugget, 1, 6), OreDictionary.getOres("dropHoney").get(0)};
		chance = new int[]{15, 75};
		...
		products = new ItemStack[]{new ItemStack(Items.nugget, 1, 7), OreDictionary.getOres("dropHoney").get(0)};
		chance = new int[]{15, 75};
		...
		products = new ItemStack[]{new ItemStack(Items.nugget, 1, 8), OreDictionary.getOres("dropHoney").get(0)};
		chance = new int[]{15, 75};
		...
		products = new ItemStack[]{new ItemStack(Items.nugget, 1, 9), OreDictionary.getOres("dropHoney").get(0)};
		chance = new int[]{15, 75};
		...
		products = new ItemStack[]{new ItemStack(Items.nugget, 1, 10), OreDictionary.getOres("dropHoney").get(0)};
		chance = new int[]{15, 75};
